...
<head>
    ...
    <script src="/breeze/codes/js/ocupacoes.js" defer></script>
            ...
            if ($ocupacao) {
              foreach ($ocupacao as $row) {
                ...
                echo '<tr class="text-center align-middle">
                        ...
                        <td>'.$row["ocupacao"].'</td>
                        <td class="p-1">
                          <button class="btn btn-primary btn-sm w-100 ver-reservas-btn" data-idocupacao="'.$row["idocupacao"].'" data-bs-toggle="modal" data-bs-target="#modalReservas">
                            Ver Reservas
                          </button>
                        </td>
                        <td class="p-1">
                          <button class="btn btn-success btn-sm w-49 btn-editar" data-id="' . htmlspecialchars($row["idocupacao"]) . '" data-bs-toggle="modal" data-bs-target="#modalEditar">
                            Editar
                          </button> 
                          <button class="btn btn-danger btn-sm w-49" onclick="removerHospede('.$row["idocupacao"].')">
                            Remover
                          </button>
                        </td>
                      </tr>';
