...
<head>
    ...
    <script src="/breeze/codes/js/adm/add/c_ocupacoes.js?v=<?= time() ?>" defer></script>
    <link rel="icon" href="/breeze/images/logo.ico">
    <title> Criar Ocupações </title>
    <style>
        body {
            max-height: 1vh;
            overflow: hidden;
            ...
            <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                <div class="form-card card mb-4">
                    ...
                    <div class="form-header card-header">
                        ...
                        <h2 class="text-center mb-0"><i class="bi bi-building me-2"></i> Adicionar Ocupação </h2>
                    </div>
                        ...
                        <form method="POST" id="ocupacaoForm">
                            ...
                            <div class="mb-4">
                                <label for="ocupacao" class="form-label">
                                    <i class="bi bi-card-heading me-2"></i>Nome da Ocupação
                                </label>
                            ...
                            <div class="d-grid mt-4">
                                <button type="submit" class="btn btn-submit text-white py-2">
                                    <i class="bi bi-check-circle me-2"></i>Salvar Ocupação
                                </button>
                            </div>
